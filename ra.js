...
var grammar = {
    ...
    {"name": "Join", "symbols": ["Expression", "_", {"literal":"⋈"}, "Cond", "_", "Expression"]},
    {"name": "LOJoin", "symbols": ["Expression", "_", {"literal":"⟕"}, "Cond", "_", "Expression"]},
    {"name": "ROJoin", "symbols": ["Expression", "_", {"literal":"⟖"}, "Cond", "_", "Expression"]},
    {"name": "FOJoin", "symbols": ["Expression", "_", {"literal":"⟗"}, "Cond", "_", "Expression"]},
    {"name": "LSJoin", "symbols": ["Expression", "_", {"literal":"⋉"}, "Cond", "_", "Expression"]},
    {"name": "RSJoin", "symbols": ["Expression", "_", {"literal":"⋊"}, "Cond", "_", "Expression"]},
    ...
    {"name": "Attr", "symbols": ["Ident", {"literal":"."}, "Ident"], "postprocess": ([rel, _, attr]) => new Attribute(rel, attr)},
